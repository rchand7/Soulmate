...
const CreateBiodata = () => {
    ...
    // biodata ID counter
    const [currentBiodataID, setCurrentBiodataID] = useState({});

    axiosPublic.get("/biodataIdCounters")
        .then(res => {
            setCurrentBiodataID(res.data.biodataId);
        })

    // new biodata ID
    const newBiodataID = currentBiodataID + 1;
    ...
    const handleSubmit = (e) => {
        ...
        const updatedFormData = { ...formData, creationDate: currentDateTime, biodataId: newBiodataID, biodataStatus: "regular" };

        // Send data to server
        console.log("Form data:", updatedFormData);
        axiosPublic.post("/biodatas", updatedFormData)
            .then((res) => {
                console.log("axios response : ", res.data);
                // Showing alert for redirecting to home page
                if (res.data.insertedId) {
                    Swal.fire({
                        title: "Successfully created your biodata!!!",
                ...
                // updating new biodata id
                axiosPublic.patch("/biodataIdCounters", { biodataId: newBiodataID })
                   .then(res => {
                        console.log("Updated biodata id: ", res.data);
                    })
                   .catch(err => {
                        console.log(err);
                    })
        ...
        <div className="container mx-auto p-4">
            ...
            <form onSubmit={handleSubmit} className="max-w-lg mx-auto">
                ...
                <div className="mb-4">
                    ...
                    <select name="height" id="height" className="w-full border rounded py-2 px-3" onChange={handleChange}>
